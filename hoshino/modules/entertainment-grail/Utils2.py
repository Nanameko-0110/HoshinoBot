...
async def shop(userQQ):
    p = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/UserAssistance/shop.json'
    pG = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/Goods/Goods.json'
...
async def priceAfterGettingBonus(id):
    ...
    p = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/Goods/Goods.json'
    content = await Utils.readFileToJSON(p)
    if content == error:
        raise GrailExcept
...
async def backpackHelp(userQQ):
    msg = await Utils.atQQ(userQQ)
    p = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/UserAssistance/BackpackHelpInformation.json'
    content = await Utils.readFileToJSON(p)
    if content == error:
        raise GrailExcept
    msg += content['prefix'] + '\n\n' + content['core'] + '\n\n' + content['suffix']
