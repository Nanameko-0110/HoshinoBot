...
async def helpMenu(userQQ):
    p = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/UserAssistance/help.json'
    msg = ''
...
async def customParameterReading(fieldName):
    p = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/Custom/CustomParameters.json'
    content = await Utils.readFileToJSON(p)
    if content == error:
        raise GrailExcept
...
async def extractQualityUnit():
    p = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/Skill/Quality.json'
    content = await Utils.readFileToJSON(p)
    if content == error:
        raise GrailExcept
...
async def extractSkillsFromWarehouse():
    p = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/Skill/SkillDepository.json'
    content = await Utils.readFileToJSON(p)
    if content == error:
        raise GrailExcept
...
async def registeredAttendant(bot, followerQQ, followerGroup, userQQ):
    ...
    pTemplate = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/Register/FollowerTemplate.json'
...
async def getTheFirstMessageOfCaptureResultOrFailure(id, model = 'success'):
    p = os.getcwd() + '/hoshino/modules/entertainment-grail/Config/Catch/information.json'
    content = await Utils.readFileToJSON(p)
    if content == error:
        raise GrailExcept
    if model == 'success':
